...
<html lang="en" class="light-style layout-menu-fixed layout-navbar-fixed" dir="ltr" data-theme="theme-default"
  ...
  <head>
	...
	<title><?php echo $_SESSION['lawFirmName']?>'s Corporate Clients</title>
	          						...
	          						<div class="card-body">
	          							<div class="table-responsive text-nowrap">
		          							<table id="allTables" class="table table-light">
											    ...
											    <tbody id="">
											        <?php fetchLawFirmCorporateClients(); ?>
											    </tbody>
											</table>
										</div>
	          						</div>
										      ...
										      <div class="modal-body">
										        <form id="clientsForm">
										          	...
										          	<div id="corporateFields" style="display: none;">
													    ...
													    <div class="mb-3">
													        <label for="representative_phone" class="form-label">Representative Phone</label><br>
													        <input type="phone" class="form-control" id="representative_phone" name="representative_phone" required >
													    </div>
										          	...
										          	<div id="individualFields" style="display: none;">
												          ...
												          <div class="mb-3">
											            	<label for="client_phone" class="form-label">Client Phone</label><br>
