											            ...
											            <table class="table table-striped" id="allTables">
											                ...
											                <tbody>
											                    <?php foreach ($results as $row): 
											                        ...
											                        <tr>
											                        	<td>
											                                <a href="track-timer?clientId=<?php echo $row['clientId']?>&caseId=<?php echo $row['caseId']?>"><?php
											                            ...
											                            <td><a href="track-timer?clientId=<?php echo $row['clientId']?>&caseId=<?php echo $row['caseId']?>"><?php echo html_entity_decode($clientNames); ?></a></td>
											                            <td><a href="track-timer?clientId=<?php echo $row['clientId']?>&caseId=<?php echo $row['caseId']?>"><?php echo html_entity_decode($caseNo); ?></a></td>
