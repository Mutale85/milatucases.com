				      				...
				      				<?php 
				      					...
				      					if($queryFiles->rowCount() > 0){
				      						...
				      						?>
				      							<tr>
				      									<td>
					      									<a href="caseDocuments/<?php echo $row['documentName']?>"><?php echo html_entity_decode($row['documentName'])?></a>
					      								</td>
						    ...
						    <div class="modal-content">
						      	...
						      	<div class="modal-body">
						        	<form id="sendEmailForm">
						          		...
						          		<input type="hidden" id="caseId" value="<?php echo $caseId?>">
  ...
  <?php include '../addon_footer_links.php';?>
    ...
    $('#generatePdf').on('click', function() {
        ...
        $.ajax({
            ...
            beforeSend:function(){
                $("#generatePdf").prop("disabled", true).html("<i class='bi bi-hourglass-top'></i> Processing...");
            },
            success: function(response) {
            	if (response.success) {
              ...
              $("#generatePdf").prop("disabled", false).html('Generate PDF');
            },
            error: function() {
