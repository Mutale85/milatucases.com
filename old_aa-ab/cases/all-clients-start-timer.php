											        ...
											        <?php
												        ...
												        foreach ($cases as $case) {
												        	...
												        	if (userHasAccessToCase($_SESSION['user_id'], $caseId, $_SESSION['parent_id'])) {?>
													            <tr>
													            	<td><a href="track-timer?clientId=<?php echo $clientId?>&caseId=<?php echo $caseId?>"><i class="bi bi-alarm"></i> Time Your Self</a></td>
														            ...
														            <td>
														            	<?php echo fetchCaseLayersAsFullNames($caseNo)?>
														            </td>
