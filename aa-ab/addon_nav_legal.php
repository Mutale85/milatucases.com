  ...
  <!-- Dashboard -->
    ...
    <li class="menu-item">
      <a href="billings/bill"
        ...
        <div data-i18n="Profile">New / View Invoice</div>
      </a>
    </li>
    <li class="menu-item">
    ...
    <li class="menu-item">
      ...
      <?php 
        ...
        $userRole = $_SESSION['user_role']; // Assuming user role is stored in session
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="docs/ai-docs" class="menu-link">
            <div data-i18n="Matter Documents">AI Generated</div>
          </a>
        </li>
        <li class="menu-item">
