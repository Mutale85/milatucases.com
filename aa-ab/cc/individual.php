...
<html lang="en" class="light-style layout-menu-fixed layout-navbar-fixed" dir="ltr" data-theme="theme-default"
  ...
  <head>
	...
	<title><?php echo $_SESSION['lawFirmName']?>'s Individual Clients</title>
          					...
          					<div class="col-md-12">
	          					<div class="card">
	          						<div class="card-header">
	          							<h5 class="card-title text-primary">Individual Clients</h5>
	          						</div>
	          						<div class="card-body">
	          							<div class="table-responsive text-nowrap">
		          							<table id="allTables" class="table table-light">
														    ...
														    <tbody id="displayIndividual">
														        <?php fetchLawFirmIndividualClients(); ?>
														    </tbody>
														</table>
													</div>
	          						</div>
													  ...
													  <div class="modal-dialog modal-xl">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="clientModalLabel">Please Add Individual Client</h5>
