...
const server = https.createServer({
  cert: fs.readFileSync('/etc/letsencrypt/live/milatucases.com/fullchain.pem'),
  key: fs.readFileSync('/etc/letsencrypt/live/milatucases.com/privkey.pem')
});
...
server.listen(8080, () => {
    console.log('HTTPS/WebSocket server is running on port 8080');
});
...
console.log('HTTPS/WebSocket server started. Waiting for connections...');